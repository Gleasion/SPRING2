...
// AbstractView 클래스를 상속받아 rederMergedOutputModel 메소드를 재정의하여 사용하면
...
public class NoticeDownloadView extends AbstractView {
	...
	protected void renderMergedOutputModel(Map<String, Object> model, HttpServletRequest request,
		...
		if(StringUtils.containsIgnoreCase(agent, "msie") || StringUtils.containsIgnoreCase(agent, "trident")) {	// IE, Chrome 일때
