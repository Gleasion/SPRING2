...
public class ImageUpload {
	...
	public String imageUpload(
		...
		PrintWriter printWriter = null;			// 본문 내용에 추가한 이미지 파일로 생성할 객체
		OutputStream out = null;				// 본문 내용에 추가한 이미지 파일로 생성할 객체
		long limitSize = 1024 * 1024 * 2;		// 업로드 파일 최대 크기 (2MB)
		
		// CKEditor 본문 내용에 이미지를 업로드 해보면 'upload'라는 키로 파일 데이터가 전달되는걸 확인할 수있다.
						...
						/*
							{
								...
								"url" : "/resources/img/xxxxxxx-xxxxxxx.img
						 */
